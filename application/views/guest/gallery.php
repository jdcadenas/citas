        ...
        <div class="gallery-grids-top">
            <div class="gallery-grids">
                <div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img">
                    <a class="example-image-link w3-agilepic" href="<?= base_url('plantilla/images/image12.jpg') ?>" data-lightbox="example-set" data-title="">
                        <img class="example-image img-responsive" src="<?= base_url('plantilla/images/image12.jpg') ?>" alt=""/>
                ...
                <div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img  hover ehover14">
                    <a class="example-image-link w3-agilepic" href="<?= base_url('plantilla/images/image4.jpg') ?>" data-lightbox="example-set" data-title="">
                        <img class="example-image img-responsive" src="<?= base_url('plantilla/images/image4.jpg') ?>" alt=""/>
                        <div class="w3ls-overlay">
                            <h4>Espacios</h4>
                        </div>
                    </a>
                ...
                <div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14">
                    <a class="example-image-link w3-agilepic" href="<?= base_url('plantilla/images/image5.jpg') ?>" data-lightbox="example-set" data-title="">
                        <img class="example-image img-responsive" src="<?= base_url('plantilla/images/image5.jpg') ?>" alt=""/>
                        <div class="w3ls-overlay">
                            <h4>BabyGym</h4>
                        </div>
                    </a>
                ...
                <div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14">
                    <a class="example-image-link w3-agilepic" href="<?= base_url('plantilla/images/image3.jpg') ?>" data-lightbox="example-set" data-title="">
                        <img class="example-image img-responsive" src="<?= base_url('plantilla/images/image3.jpg') ?>" alt=""/>
                        <div class="w3ls-overlay">
                            <h4></h4>
                        </div>
                    </a>
