...
<div class="gallery">
    <div class="container">
        <h3 class="w3ls-title">Nuestras fotos</h3>
        <div class="gallery-grids-top">
            <div class="gallery-grids">
                ...
                <div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img">
                    <a class="example-image-link w3-agilepic" href="<?= base_url('plantilla/images/s1.jpg') ?>" data-lightbox="example-set" data-title="">
                        <img class="example-image img-responsive" src="<?= base_url('plantilla/images/s1.jpg') ?>" alt=""/>
                        <div class="w3ls-overlay">
                            <h4>Psicología</h4>
                        </div>
                    </a>
                ...
                <div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14">
                    <a class="example-image-link w3-agilepic" href="<?= base_url('plantilla/images/s3.jpg') ?>" data-lightbox="example-set" data-title="">
                        <img class="example-image img-responsive" src="<?= base_url('plantilla/images/s3.jpg') ?>" alt=""/>
                        <div class="w3ls-overlay">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6 gallery-grid-img gallery-mdl hover ehover14">
                    <a class="example-image-link w3-agilepic" href="<?= base_url('plantilla/images/img5.jpg') ?>" data-lightbox="example-set" data-title="">
                        <img class="example-image img-responsive" src="<?= base_url('plantilla/images/img5.jpg') ?>" alt=""/>
                        <div class="w3ls-overlay">
                            <h4>Nuestras fotos</h4>
                        </div>
                    </a>
                ...
                <div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14">
                    <a class="example-image-link w3-agilepic" href="<?= base_url('plantilla/images/img3.jpg') ?>" data-lightbox="example-set" data-title="">
                        <img class="example-image img-responsive" src="<?= base_url('plantilla/images/img3.jpg') ?>" alt=""/>
                        <div class="w3ls-overlay">
                            <h4>Terapia de lenguage</h4>
                        </div>
                    </a>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14">
                ...
                <div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14">
                    <a class="example-image-link w3-agilepic" href="<?= base_url('plantilla/images/nino2.jpg') ?>" data-lightbox="example-set" data-title="">
                        <img class="example-image img-responsive" src="<?= base_url('plantilla/images/nino2.jpg') ?>" alt=""/>
                        <div class="w3ls-overlay">
                            <h4>Nuestras fotos</h4>
                        </div>
                    </a>
                ...
                <div class="col-md-4 col-sm-4 col-xs-6 gallery-grid-img hover ehover14">
                    <a class="example-image-link w3-agilepic" href="<?= base_url('plantilla/images/service03-1.jpg') ?>" data-lightbox="example-set" data-title="">
                        <img class="example-image img-responsive" src="<?= base_url('plantilla/images/service03-1.jpg') ?>" alt=""/>
                        <div class="w3ls-overlay">
                            <h4>Psicopedagogía</h4>
                        </div>
                    </a>
                ...
                <script src="<?= base_url('plantilla/js/lightbox-plus-jquery.min.js') ?>"></script>
            </div>
        </div>
    </div>
</div>
