                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                ...
                                <!--      <div class="form-group">
                                      <label for="repeat_event" class="control-label col-sm-3" ><?php echo $this->lang->line('repeat_event'); ?></label>
                                      <div class="col-sm-6">
                                        <select id="select-repeat" class="required form-control">
                                          <option value="0" selected><?php echo $this->lang->line('no_repeat'); ?></option>
                                          <option value="1"><?php echo $this->lang->line('weekly'); ?></option>
                                          <option value="2"><?php echo $this->lang->line('weekly2'); ?></option>
                                          <option value="3"><?php echo $this->lang->line('monthly'); ?></option>
                                        </select>
                                      </div>
                                    </div>
                                -->
