...
<script src="<?= asset_url('assets/js/backend_invoices.js') ?>"></script>
                    ...
                    <div class="details-view provider-view">
                        ...
                        <div class="row">
                            <div class="provider-details col-xs-12 col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="provider-color"><?= lang('color') ?></label>
                                    <input type="color" id="provider-color" class="form-control" maxlength="256">
                                </div>
                            </div>
