...
class Appointments_Model extends CI_Model {
    ...
    public function validate($appointment) {
        ...
        if (isset($appointment['id'])) {
            ...
            $num_rows = $this->db->get_where('ea_appointments', ['id' => $appointment['id']])->num_rows();
            if ($num_rows == 0) {
        ...
        if ($appointment['is_unavailable'] == FALSE) {
            ...
            $num_rows = $this->db->get_where('ea_services', ['id' => $appointment['id_services']])->num_rows();
            if ($num_rows == 0) {
    ...
    public function clear_google_sync_ids($provider_id) {
        ...
        $this->db->update('ea_appointments', ['id_google_calendar' => NULL], ['id_users_provider' => $provider_id]);
    }
