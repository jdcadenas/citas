...
(function(exports) {
    ...
    function _bindEventHandlers() {
         ...
         *
         * Closes the dialog without saving any es to the database.
         */
        ...
        $('#manage-appointment #save-appointment').click(function() {
            ...
            var attendancestatus = $("#manage-appointment .estado").val();
        ...
        $("#estado input[type=radio]").click(function() {
            ...
            $("#estado input[type=radio]").not('[checked=checked]').removeClass('active').addClass('noActive').prop("checked", false);
            $("#estado input[value=" + selected + '"]').removeClass('noActive').addClass('active').prop("checked");
    ...
    exports.resetAppointmentDialog = function() {
        ...
        $('#manage-appointment .estado').prop('checked', false);
